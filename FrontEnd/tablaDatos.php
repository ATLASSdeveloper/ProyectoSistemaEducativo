        ...
        <nav class="navbar navbar-expand-sm navbar-default" style="background-color:#c13d19;">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                ...
                <li class="menu-title" style="color:white">Dashboard</li>
                    ...
                    <li><a href="paginaPrincipal.php" style="color:white;">Mis cursos</a></li>
                    <li><a href="tablaDatos.php" style="color:white;">Participantes</a></li>
                </ul>
            </div>
        </nav>
    </aside>
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            echo listadoEstudiantes($codigo);
                                            ?>
                                    </tbody>
                                </table>
                            </div>
