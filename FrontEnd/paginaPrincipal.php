                           ...
                           echo " <li class='menu-item-has-children dropdown'>
                            ...
                            if($_SESSION['rol']=="docente"){
                                ...
                                if($_SESSION['rol']=="administrador"){
                                    echo "<li><a href='crudUsuarios.php' style='color:white;'>Usuarios</a></li>";
                                    echo "<li><a href='crudMaterias.php' style='color:white;'>Materias</a></li>";
                                }
                            }
                        }
                    ?>
                ...
                <div class="row">
                    ...
                    <?php
                        ...
                        if($_SESSION['rol']=='administrador'){
                            ...
                            echo esAdmin($_SESSION['user']);
                        }else{
                            if($_SESSION['rol']=='invitado'){
                                echo mostrarMatriculas(0,$_SESSION['user']);
                            }else{
                            echo materiasRegistradas($_SESSION['user'],$_SESSION['rol']);
                            }
                        }
