...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
            ...
            <form method="POST" enctype="multipart/form-data" action="../BD/ingreso.php">
  <div class="form-group">
    <label for="exampleInputEmail1">Nombre del deber</label>
    <input  class="form-control" id="nombreDEBER" name="nombreDEBER" placeholder="introduzca el nombre del deber">
  </div>
  <div class="form-group">
    <label for="exampleFormControlTextarea1">Descripcion del deber</label>
    <textarea class="form-control" id="descripcion" rows="3" placeholder="Introduzca la descripcion del deber" name="des"></textarea>
  </div>
<div>

<h4><label for="exampleFormControlTextarea1">Registre la fecha/hora maxima de entrega</label><br></h4>
  ...
  <br>
  <button type="submit" class="btn btn-danger btn-lg" id="botonDEBER" >Crear deber</button>
</form>
