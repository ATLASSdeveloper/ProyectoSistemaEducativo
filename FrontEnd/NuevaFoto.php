...
<head>
    ...
    <script src="../js/tomafoto.js"></script>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold " style="color:#c13d19">Participantes</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th style="background-color:#c13d19; color: white">Foto actual</th>
                                            <th style="background-color:#c13d19; color: white"> Camara</th>
                                            <th style="background-color:#c13d19; color: white">Foto tomada</th>
                                        </tr>
                                    </thead>
                                    <tfoot>
                                        <tr>
                                    ...
                                    <tbody>
                                    <td>
<a><img src='data:image/png;base64,<?php echo base64_encode($imagen)?>' width='230' height='230'></a>
</td>
...
<canvas id="canvas" width="320" height="240"></canvas>
    ...
    <div align=center>
        <button class="btn btn-danger " id="start-camera">Encender camara</button>
        <button class="btn btn-danger " id="click-photo">Tomar foto</button>
        <a href="informacionPersonal.php"><button class="btn btn-danger " id="act">Guardar foto</button> </a>
    </div>
        <!-- Footer -->
